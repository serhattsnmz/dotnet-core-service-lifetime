...
namespace TestServices.Repository
{
    public class ScopeRepo2
    {
        ...
        public ScopeRepo2(IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            Console.WriteLine(">>>>>");
            Console.WriteLine(">>>>> Write Function | ScopeRepo 2 | Function 1");
        ...
        {
            Console.WriteLine(">>>>>");
            Console.WriteLine(">>>>> Write Function | ScopeRepo 2 | Function 2");
